...
const BUILDS = [
    ...
    'Dart Native'  => 'mkdir -p /var/regex/dart/bin && dart compile exe dart/benchmark.dart -o dart/bin/benchmark',
...
const COMMANDS = [
    ...
    'C# .Net Core' => 'dotnet csharp/bin/Release/net8.0/benchmark.dll',
